...
The data dictionary of the dataset can be found in .txt form file.

Data Source: The dataset can be found here.
https://drive.usercontent.google.com/download?id=1VNpyNkGxHdskfdTNRSjjyNa5qC9u0JyV&export=download
